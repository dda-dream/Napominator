        ...
        public void Start_NoiseDetector()
        {
            ...
            catch
            {
                ...
                if (GetDoubleFromSettings("[LockWorkStation_NoMicrophone]") == 1)
                {
                    ...
                    Show_Message_To_Polina("�������� ��������! \n ������ �� 0-��! "+ count_NoMicrophoneDetected.ToString(), "�������� ��������!", true, false, false, 5);
            ...
            if (continuousBig >= maxNoiseLevel)
            {
                ...
                if (GetDoubleFromSettings("[Show_Message_To_Polina]") == 1)
                {
                    if (USERNAME.Contains("d"))
                        Show_Message_To_Polina("�� ����!!! \n ��� �������!!!", "�� ����!!! " + levelsStr, true,  true, false, 15);
                    else
                        Show_Message_To_Polina("�� ����!!! \n ��� �������!!!", "�� ����!!! " + levelsStr, true, false, false, 15);
                }
                ...
                {//����������� �����
                    if( GetDoubleFromSettings("[BlockChrome]")==1 )
                        if (curWinTitle.Contains("chrome") || curWinTitle.Contains("edge") || curWinTitle.Contains("firefox"))
                        {
                            ...
                            if (!foundany)
                                Show_Message_To_Polina("BlockChrome" + Parse_NotifyText(), "�����������! BlockChrome " + curWinTitle);
                        }

                    if ( GetDoubleFromSettings("[BlockTotal]")==1 )
                        Show_Message_To_Polina("TotalBlock" + Parse_NotifyText(), "�����������! TotalBlock " + curWinTitle);
                }
                else
                {//�� ����������� �����
                    bool foundany = curWinTitle == "" || CheckStringContainsInList(curWinTitle, GetStringFromSettings("[ExcludeFromBlock]"));
                    if (!foundany)
                        Show_Message_To_Polina("Allowed time from " + dt_from.ToShortTimeString() + " to " + dt_to.ToShortTimeString() + Parse_NotifyText(), "�����������! Allowed time " + curWinTitle);
                }
                //���� �� ������
                if( CheckStringContainsInList(curWinTitle, GetStringFromSettings("[Blocklist]")) )
                    Show_Message_To_Polina("BlockList", "�����������! BlockList " + curWinTitle);
            }
            else
            {// MAMA and PAPA
             //���� �� ������
                ...
                {
                    if (CheckStringContainsInList(curWinTitle, GetStringFromSettings("[Blocklist]")))
                        Show_Message_To_Polina("BlockList" + Parse_NotifyText(), "�����������! BlockList " + curWinTitle);
                ...
                {
                    Show_Message_To_Polina(Parse_NotifyText(), "�����������!", false, true);
                }
            }
